...
export class G2PSupersetDashboard extends Component {
    ...
    async getSupersertUrl(orm) {
           const data = await orm.searchRead("ir.config_parameter", [["key", "=", "g2p_superset_dashboard.superset_url"]], ['value']);
        ...
        // this.superSetUrl = data && data["0"]["value"] ? data["0"]["value"] : false;
        this.state.isLoading = false
        // this.attemptLogin(data["0"]["value"])
        // this.attemptLogin()
